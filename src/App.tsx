...
const translationDictionary: Record<string, Record<string, string>> = {
  ...
  sv: {
    "vélo d'appartement": "Träningscykel",
    "vélo tout chemin": "Hybridcykel",
    "vélo de ville enjambement bas": "Damcykel med lågt insteg",
    "vélo de ville": "Stadsbycykel",
    "vélo de route": "Racercykel",
    "vélo route": "Racercykel",
    "vélo vtt": "Mountainbike (MTB)",
    "vtt": "Mountainbike (MTB)",
    "poche à eau": "Vattenblåsa",
    "bâton de randonnée": "Vandringsstav",
    "bâton ultra-compact": "Ultrakompakt stav",
    "bâton": "Vandringsstav",
    "lampe frontale": "Pannlampa",
    "gourde": "Vattenflaska",
    "repas lyophilisé": "Frystorkad måltid",
    "pâtes à la bolognaise": "Pasta Bolognese",
    "riz et poulet au curry": "Ris med kycklingcurry",
    "purée de pomme de terre à la viande hachée": "Potatismos med köttfärs",
    "sans gluten": "Glutenfri",
    "tapis de sol": "Träningsmatta",
    "tapis de course": "Löpband",
    "tapis de protection sol": "Golvskyddsmatta",
    "tapis de marche": "Gångmatta",
    "vélo elliptique": "Crosstrainer",
    "rameur": "Rodmaskin",
    "montre gps de sport": "GPS-sportklocka",
    "montre connectée gps": "GPS-smartklocka",
    "montre connectée": "Smartklocka",
    "montre gps": "GPS-klocka",
    "popote": "Campingkokset",
    "isotherme inox": "Isolerat rostfritt stål",
    "isotherme": "Isolerad",
    "bouchon à ouverture rapide": "Snabböppningskork",
    "pour la randonnée": "för vandring",
    "en acier inox": "i rostfritt stål",
    "anti-adhésif": "Non-stick",
    "personnes": "Personer",
    "éléments": "Delar",
    "réglage rapide et précis": "Snabb och exakt justering",
    "connecté et auto-alimenté": "Ansluten och självförsörjande",
    "auto-alimenté et connecté": "Självförsörjande och ansluten",
    "résistance motorisée": "Motoriserat motstånd",
    "auto-alimenté": "Självförsörjande",
    "connecté": "Ansluten",
    "pliable": "Hopfällbar",
    "garanti par decathlon": "Garanterad av Decathlon",
    "cadre haut": "Hög ram",
    "cadre bas": "Låg ram",
    "enjambement bas": "Lågt insteg",
    "bleu nuit": "Nattblå",
    "bleu tempête": "Stormblå",
    "gris foncé": "Mörkgrå",
    "gris clair": "Ljusgrå",
    "vert bouteille": "Flaskgrön",
    "vert amande": "Mandelgrön",
    "bleu": "Blå",
    "vert": "Grön",
    "noir": "Svart",
    "blanc": "Vit",
  ...
  pl: {
    "vélo d'appartement": "Rower stacjonarny",
    "vélo tout chemin": "Rower trekkingowy/hybrydowy",
    "vélo de ville enjambement bas": "Miejski rower z niską ramą",
    "vélo de ville": "Rower miejski",
    "vélo de route": "Rower szosowy",
    "vélo route": "Rower szosowy",
    "vélo vtt": "Rower górski (MTB)",
    "vtt": "Rower górski (MTB)",
    "poche à eau": "Bukłak na wodę",
    "bâton de randonnée": "Kij trekkingowy",
    "bâton ultra-compact": "Ultrakompaktowy kijek",
    "bâton": "Kij",
    "lampe frontale": "Latarka czołowa",
    "gourde": "Bidon/Butelka",
    "repas lyophilisé": "Liofilizowany posiłek",
    "pâtes à la bolognaise": "Makaron po bolońsku",
    "riz et poulet au curry": "Ryż z kurczakiem w sosie curry",
    "purée de pomme de terre à la viande hachée": "Purée ziemniaczane z mięsem mielonym",
    "sans gluten": "Bezglutenowy",
    "tapis de sol": "Mata do ćwiczeń",
    "tapis de course": "Bieżnia",
    "tapis de protection sol": "Mata ochronna pod sprzęt",
    "tapis de marche": "Bieżnia płaska",
    "vélo elliptique": "Minitrenażer eliptyczny",
    "rameur": "Wioślarz treningowy",
    "montre gps de sport": "Sportowy zegarek GPS",
    "montre connectée gps": "Smartwatch GPS",
    "montre connectée": "Smartwatch",
    "montre gps": "Zegarek GPS",
    "popote": "Zestaw naczyń turystycznych",
    "isotherme inox": "Termiczny ze stali nierdzewnej",
    "isotherme": "Termiczny",
    "bouchon à ouverture rapide": "Korek z szybkim otwieraniem",
    "pour la randonnée": "do wędrówek",
    "en acier inox": "ze stali nierdzewnej",
    "anti-adhésif": "Nieprzywierający",
    "personnes": "Osobowa",
    "éléments": "Elementy",
    "réglage rapide et précis": "Szybka i precyzyjna regulacja",
    "connecté et auto-alimenté": "Połączony i bezprzewodowy",
    "auto-alimenté et connecté": "Bezprzewodowy i połączony",
    "résistance motorisée": "Opór automatyczny",
    "auto-alimenté": "Zasilany ruchem",
    "connecté": "Połączony",
    "pliable": "Składany",
    "garanti par decathlon": "Gwarancja Decathlon",
    "cadre haut": "Wysoka rama",
    "cadre bas": "Niska rama",
    "enjambement bas": "Niski przekrok",
    "bleu nuit": "Granatowy",
    "bleu tempête": "Niebieski sztormowy",
    "gris foncé": "Ciemnoszary",
    "gris clair": "Jasnoszary",
    "vert bouteille": "Butelkowa zieleń",
    "vert amande": "Migdałowa zieleń",
    "bleu": "Niebieski",
    "vert": "Zielony",
    "noir": "Czarny",
    "blanc": "Biały",
  ...
  tr: {
    "vélo d'appartement": "Kondisyon Bisikleti",
    "vélo tout chemin": "Hibrit Bisiklet",
    "vélo de ville enjambement bas": "Alçak Kadro Şehir Bisikleti",
    "vélo de ville": "Şehir Bisikleti",
    "vélo de route": "Yol Bisikleti",
    "vélo route": "Yol Bisikleti",
    "vélo vtt": "Dağ Bisikleti (MTB)",
    "vtt": "Dağ Bisikleti (MTB)",
    "poche à eau": "Su Torbası",
    "bâton de randonnée": "Trekking Bastonu",
    "bâton ultra-compact": "Ultra Alçak Katlanır Baston",
    "bâton": "Baston",
    "lampe frontale": "Kafa Lambası",
    "gourde": "Suluk/Matara",
    "repas lyophilisé": "Dondurularak Kurutulmuş Yemek",
    "pâtes à la bolognaise": "Bolonez Soslu Makarna",
    "riz et poulet au curry": "Köri Soslu Tavuklu Pilav",
    "purée de pomme de terre à la viande hachée": "Kıymalı Patates Püresi",
    "sans gluten": "Glutensiz",
    "tapis de sol": "Zemin Minderi",
    "tapis de course": "Koşu Bandı",
    "tapis de protection sol": "Zemin Koruma Matı",
    "tapis de marche": "Yürüyüş Bandı",
    "vélo elliptique": "Eliptik Bisiklet",
    "rameur": "Kürek Aleti",
    "montre gps de sport": "GPS Spor Saati",
    "montre connectée gps": "GPS Akıllı Saat",
    "montre connectée": "Akıllı Saat",
    "montre gps": "GPS Saat",
    "popote": "Kamp Yemek Seti",
    "isotherme inox": "Paslanmaz Çelik Termos",
    "isotherme": "Termos",
    "bouchon à ouverture rapide": "Hızlı Açılan Kapak",
    "pour la randonnée": "Doğa Yürüyüşü İçin",
    "en acier inox": "Paslanmaz Çelik",
    "anti-adhésif": "Yapışmaz",
    "personnes": "Kişilik",
    "éléments": "Parça",
    "réglage rapide et précis": "Hızlı ve Hassas Ayar",
    "connecté et auto-alimenté": "Bağlantılı ve Kendinden Güç Alan",
    "auto-alimenté et connecté": "Kendinden Güç Alan ve Bağlantılı",
    "résistance motorisée": "Motorlu Direnç",
    "auto-alimenté": "Elektriksiz Çalışan",
    "connecté": "Bağlantılı",
    "pliable": "Katlanabilir",
    "garanti par decathlon": "Decathlon Garantili",
    "cadre haut": "Yüksek Kadro",
    "cadre bas": "Alçak Kadro",
    "enjambement bas": "Kolay Geçişli Kadro",
    "bleu nuit": "Gece Mavisi",
    "bleu tempête": "Fırtına Mavisi",
    "gris foncé": "Koyu Gri",
    "gris clair": "Açık Gri",
    "vert bouteille": "Şişe Yeşili",
    "vert amande": "Badem Yeşili",
    "bleu": "Mavi",
    "vert": "Yeşil",
    "noir": "Siyah",
    "blanc": "Beyaz",
  ...
  ko: {
    "vélo d'appartement": "실내 자전거",
    "vélo tout chemin": "하이브리드 자전거",
    "vélo de ville enjambement bas": "저지상고 도시형 자전거",
    "vélo de ville": "도시형 자전거",
    "vélo de route": "로드 자전거",
    "vélo route": "로드 자전거",
    "vélo vtt": "산악 자전거 (MTB)",
    "vtt": "산악 자전거 (MTB)",
    "poche à eau": "하이드레이션 워터백",
    "bâton de randonnée": "등산 스틱",
    "bâton ultra-compact": "초소형 접이식 스틱",
    "bâton": "등산 스틱",
    "lampe frontale": "헤드램프",
    "gourde": "물병",
    "repas lyophilisé": "동결건조 아웃도어 전투식량",
    "pâtes à la bolognaise": "볼로네제 파스타",
    "riz et poulet au curry": "치킨 커리 라이스",
    "purée de pomme de terre à la viande hachée": "다진 소고기를 곁들인 감자 퓌레",
    "sans gluten": "글루텐 프리",
    "tapis de sol": "요가 매트",
    "tapis de course": "러닝머신",
    "tapis de protection sol": "바닥 보호매트",
    "tapis de marche": "워킹패드",
    "vélo elliptique": "엘립티컬 머신",
    "rameur": "로잉 머신",
    "montre gps de sport": "GPS 스포츠 워치",
    "montre connectée gps": "GPS 스마트워치",
    "montre connectée": "스마트워치",
    "montre gps": "GPS 시계",
    "popote": "캠핑 코펠 세트",
    "isotherme inox": "스테인리스 보온",
    "isotherme": "보온/보냉",
    "bouchon à ouverture rapide": "원터치 스피드 캡",
    "pour la randonnée": "하이킹용",
    "en acier inox": "스테인리스 스틸 소재",
    "anti-adhésif": "논스틱 방지 코팅",
    "personnes": "인용",
    "éléments": "구성품",
    "réglage rapide et précis": "빠르고 정교한 조절",
    "connecté et auto-alimenté": "자가 발전형 스마트 연결",
    "auto-alimenté et connecté": "스마트 무선 연결 자가 발전형",
    "résistance motorisée": "모터 구동 전동식 저항",
    "auto-alimenté": "자가 발전식",
    "connecté": "스마트폰 연동형",
    "pliable": "접이식",
    "garanti par decathlon": "데카트론 보증",
    "cadre haut": "하이 스텝 프레임",
    "cadre bas": "로우스텝 프레임",
    "enjambement bas": "저지상고 프레임",
    "bleu nuit": "나이트 블루",
    "bleu tempête": "스톰 블루",
    "gris foncé": "다크 그레이",
    "gris clair": "라이트 그레이",
    "vert bouteille": "보틀 그린",
    "vert amande": "아몬드 그린",
    "bleu": "블루",
    "vert": "그린",
    "noir": "블랙",
  ...
  zh: {
    "vélo d'appartement": "健身车",
    "vélo tout chemin": "混合动力多功能车",
    "vélo de ville enjambement bas": "低跨步都市自行车",
    "vélo de ville": "都市通勤自行车",
    "vélo de route": "公路车",
    "vélo route": "公路车",
    "vélo vtt": "山地车 (MTB)",
    "vtt": "山地车 (MTB)",
    "poche à eau": "户外饮水袋",
    "bâton de randonnée": "徒步登山杖",
    "bâton ultra-compact": "超紧凑轻便登山杖",
    "bâton": "登山杖",
    "lampe frontale": "户外头灯",
    "gourde": "运动水壶",
    "repas lyophilisé": "冻干路餐",
    "pâtes à la bolognaise": "肉酱意面",
    "riz et poulet au curry": "咖喱鸡丁配米饭",
    "purée de pomme de terre à la viande hachée": "牛肉泥土豆沙拉",
    "sans gluten": "无麸质",
    "tapis de sol": "健身垫",
    "tapis de course": "跑步机",
    "tapis de protection sol": "地板保护垫",
    "tapis de marche": "走步机",
    "vélo elliptique": "椭圆机",
    "rameur": "划船机",
    "montre gps de sport": "GPS户外运动手表",
    "montre connectée gps": "GPS智能腕表",
    "montre connectée": "智能手表",
    "montre gps": "GPS手表",
    "popote": "野营套砚",
    "isotherme inox": "不锈钢保温",
    "isotherme": "热能保温",
    "bouchon à ouverture rapide": "便捷快开盖",
    "pour la randonnée": "适用于徒步",
    "en acier inox": "不锈钢材质",
    "anti-adhésif": "防粘涂层",
    "personnes": "人份",
    "éléments": "件套",
    "réglage rapide et précis": "精确调节",
    "connecté et auto-alimenté": "智能连接自发电",
    "auto-alimenté et connecté": "自发电自驱配智能网联",
    "résistance motorisée": "电磁阻力调节",
    "auto-alimenté": "自发电",
    "connecté": "支持智能连接",
    "pliable": "折叠设计",
    "garanti par decathlon": "迪卡侬保障",
    "cadre haut": "高车架",
    "cadre bas": "低车架",
    "enjambement bas": "易跨步结构",
    "bleu nuit": "午夜蓝",
    "bleu tempête": "风暴蓝",
    "gris foncé": "深灰色",
    "gris clair": "浅灰色",
                        ...
                        <tr className="hover:bg-slate-50/40 transition-colors">
                          ...
                          {slots.map((p, index) => (
                            <td key={index} className="py-3.5 px-5 font-bold text-slate-muted text-body-xs text-center capitalize">
                              {p ? getCategoryLabel(p.category) : <span className="text-zinc-200">-</span>}
                            </td>
                          ))}
                        </tr>
